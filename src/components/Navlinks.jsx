...
import { RiArrowDownFill, RiArrowDownSFill, RiBardLine, RiChatAiLine, RiFile4Line, RiFolderUserLine, RiNotificationLine, RiShutDownLine } from 'react-icons/ri';
  ...
  return (
    <section className='sticky lg:static top-0 flex items-center lg:items-start lg:justify-start h-[7vh] lg:h-[100vh] w-[100%] lg:w-[150px] py-8 lg:py-0 bg-[#01aa85]'>
      <main className='flex lg:flex-col items-center lg:gap-10 justify-between lg:px-0 w-[100%]'>
        <div className='flex items-start justify-center lg:border-b-1 border-[#ffffffb9] h-[81px] lg:w-[100%] p-4'>
          <span className='flex items-center justify-center'>
            <img src={logo} className='w-[56px] h-[52px] object-contain bg-white rounded-lg p-2' alt="" />
          </span>
        </div>
        <ul className='flex lg:flex-col flex-row items-centers gap-7 md:gap-10 px-2 md:px-0'>
          <li className=''>
          ...
          <li className=''>
            ...
            <button className='lg:text-[28px] text-[22px] block lg:hidden'>
