...
const Register = ({ isLogin, setIsLogin }) => {
  ...
  return (
    <section className='flex flex-col justify-center items-center h-screen background-image'>
      <div className='bg-white shadow-lg p-5 rounded-xl h-[27rem] w-[20rem] flex flex-col justify-center items-center'>
        ...
        <div className="w-full">
          <input type="text" name="fullName" onChange={handleChangeUserData} className='border border-green-200 w-full p-2 rounded-md bg-[#01aa851d] text-[#004939f3] mb-3 font-medium outline-none placeholder:text-[#00493958]' placeholder='Full Name' onChange={handleChangeUserData} />
          <input type="email" name='email' onChange={handleChangeUserData} className='border border-green-200 w-full p-2 rounded-md bg-[#01aa851d] text-[#004939f3] mb-3 font-medium outline-none placeholder:text-[#00493958]' placeholder='Email' onChange={handleChangeUserData} />
